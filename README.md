...
This project contains various examples for gathering an sending telemetry to the CloudZero telemetry API. These power allocation dimensions to help manage and understand your cloud spend.

For more information:
- https://docs.cloudzero.com/docs/enhanced-unit-cost-analytics
- https://docs.cloudzero.com/reference/telemetry
- https://docs.cloudzero.com/docs/short-form-rules#allocatebystreams-short-form-rule
